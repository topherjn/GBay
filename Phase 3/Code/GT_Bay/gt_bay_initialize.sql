...
-- Users from Leo
INSERT INTO RegularUser(username, password, first_name, last_name) VALUES ('user1', 'pass1', 'Danite', 'Kelor');
...
INSERT INTO RegularUser(username, password, first_name, last_name) VALUES ('user4', 'pass4', 'Randy', 'Roran');
...
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('Garmin GPS', 'This is a great GPS', 4, false, 50.00, 70.00, 99.00,'2018-03-31 12:22', 3, 'user1');
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('Canon Powershot', 'Point and shoot!', 3, false, 40.00, 60.00, 80.00,'2018-04-01 14:14:00', 3, 'user1');
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('Nikon D3', 'New and in box!', 5, false, 1500.00, 1800.00, 2000.00,'2018-04-05 09:19:00', 3, 'user2');
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('Danish Art Book', 'Delicious Danish Art', 4, true, 10.00, 10.00, 10.00,'2018-04-05 15:33:00', 1, 'user3');
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('SQL in 10 Minutes', 'Learn SQL really fast!', 2, false, 5.00, 10.00, 12.00,'2018-04-05 16:48:00', 2, 'admin1');
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('SQL in 8 Minutes', 'Learn SQL even fastter!', 3, false, 5.00, 8.00, 10.00,'2018-04-08 10:01:00', 2, 'admin2');
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('Pull-up Bar', 'Works on any door frame', 5, false, 20.00, 25.00, 40.00,'2018-04-09 22:09:00', 5, 'user6');

-- Items from TAs
INSERT INTO Item(item_name, description, item_condition, returnable, starting_bid, min_sale_price, get_it_now_price, auction_end_time, category_id, listing_username)
   VALUES ('Garmin GPS', 'Typical GPS unit', 3, false, 25.00, 50.00, 75.00,'2018-04-23 03:15', 3, 'admin2');
...
-- Ratings from TAs
INSERT INTO Rating(username, item_id, numstars, comments) VALUES ('user5',9, 3, 'Great for getting OMSCS coursework done.');
INSERT INTO Rating(username, item_id, numstars, comments) VALUES ('user4',10, 2, 'Looks nice but underpowered.');
INSERT INTO Rating(username, item_id, numstars, comments) VALUES ('user3',10, 3, NULL);
...
INSERT INTO Bid(username, item_id, bid_amount, bid_time) VALUES ('user4', 1, 75.00, '2018-03-30 19:28');
INSERT INTO Bid(username, item_id, bid_amount, bid_time) VALUES ('user5', 1, 85.00, '2018-03-31 10:00');
...
INSERT INTO Bid(username, item_id, bid_amount, bid_time) VALUES ('user3', 3, 1501.00, '2018-04-04 09:15');
...
INSERT INTO Bid(username, item_id, bid_amount, bid_time) VALUES ('user3', 8, 33.00, '2018-04-18 01:00');
