...
-- Add an admin user
INSERT INTO GTBayUser(username, password, first_name, last_name) VALUES ('admin01', 'password', 'Pierre', 'Omidyar');
INSERT INTO AdminUser(username, position) VALUES ('admin01', 'DBA');

-- Add regular User
INSERT INTO GTBayUser(username, password, first_name, last_name) VALUES ('user01', 'password', 'Dan', 'Smith');
INSERT INTO RegularUser(username) VALUES ('user01');
INSERT INTO GTBayUser(username, password, first_name, last_name) VALUES ('user02', 'password', 'Amy', 'Smith');
INSERT INTO RegularUser(username) VALUES ('user02');
INSERT INTO GTBayUser(username, password, first_name, last_name) VALUES ('user03', 'password', 'Anne', 'Smith');
INSERT INTO RegularUser(username) VALUES ('user03');
